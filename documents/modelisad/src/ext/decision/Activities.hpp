/*
 * @file ext/decision/Activities.hpp
 *
...
#include <ext/decision/PrecedencesGraph.hpp>
...
public:
     ...
     */
    typedef std::pair < bool, vle::devs::Time > Result;
     ...
     */
    vle::devs::Time nextDate(const vle::devs::Time& time);
     ...
     */
    Result process(const vle::devs::Time& time);
...
private:
    ...
    Result processWaitState(iterator activity, const vle::devs::Time& time);
    Result processStartedState(iterator activity, const vle::devs::Time& time);
    Result processFFState(iterator activity, const vle::devs::Time& time);
    Result processFailedState(iterator activity, const vle::devs::Time& time);
    Result processEndedState(iterator activity, const vle::devs::Time& time);
