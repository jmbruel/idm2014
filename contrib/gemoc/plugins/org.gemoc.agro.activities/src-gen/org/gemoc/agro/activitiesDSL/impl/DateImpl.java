 ...
 * <ul>
 *   <li>{@link org.gemoc.agro.activitiesDSL.impl.DateImpl#getDay <em>Day</em>}</li>
 *   <li>{@link org.gemoc.agro.activitiesDSL.impl.DateImpl#getMonth <em>Month</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DateImpl extends MinimalEObjectImpl.Container implements Date
{
  ...
  {
    return ActivitiesDSLPackage.Literals.DATE;
  }
  ...
  public void setDay(int newDay)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActivitiesDSLPackage.DATE__DAY, oldDay, day));
  }
  ...
  public void setMonth(Month newMonth)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActivitiesDSLPackage.DATE__MONTH, oldMonth, month));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ActivitiesDSLPackage.DATE__DAY:
        return getDay();
      case ActivitiesDSLPackage.DATE__MONTH:
        return getMonth();
    }
