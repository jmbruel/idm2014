...
public interface ActivitiesDSLPackage extends EPackage
{
   ...
   * @ordered
   */
  int EXPLOITATION_ACTIVITY_FEATURE_COUNT = 5;
  ...
  /**
   * Returns the meta object for the attribute '{@link org.gemoc.agro.activitiesDSL.Model#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see org.gemoc.agro.activitiesDSL.Model#getName()
   * @see #getModel()
   * @generated
   */
