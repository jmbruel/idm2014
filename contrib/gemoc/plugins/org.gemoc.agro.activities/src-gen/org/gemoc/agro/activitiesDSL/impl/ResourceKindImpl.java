 ...
 * <ul>
 *   <li>{@link org.gemoc.agro.activitiesDSL.impl.ResourceKindImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceKindImpl extends MinimalEObjectImpl.Container implements ResourceKind
{
  ...
  {
    return ActivitiesDSLPackage.Literals.RESOURCE_KIND;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActivitiesDSLPackage.RESOURCE_KIND__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ActivitiesDSLPackage.RESOURCE_KIND__NAME:
        return getName();
    }
