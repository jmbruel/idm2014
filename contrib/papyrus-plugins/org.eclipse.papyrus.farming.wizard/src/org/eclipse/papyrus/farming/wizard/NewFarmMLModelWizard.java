...
import org.eclipse.papyrus.farming.wizard.CreateFarmMLModelCommand;
import org.eclipse.papyrus.uml.diagram.wizards.CreateModelWizard;
import org.eclipse.papyrus.uml.diagram.wizards.pages.SelectDiagramCategoryPage;
import org.eclipse.ui.IWorkbench;

public class NewFarmMLModelWizard extends CreateModelWizard {
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setWindowTitle("New FarmML Model");
	}

	/**
	 * Instantiates a new new Proteus model wizard.
	 */
	public NewFarmMLModelWizard() {
		super();
