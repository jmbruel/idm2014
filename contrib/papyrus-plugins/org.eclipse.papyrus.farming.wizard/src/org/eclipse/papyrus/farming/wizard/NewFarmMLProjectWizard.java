...
public class NewFarmMLProjectWizard extends NewPapyrusProjectWizard {
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setWindowTitle("New FarmML Project");
	}
	...
	protected WizardNewProjectCreationPage createNewProjectCreationPage() {
		...
		newProjectPage.setTitle("Papyrus FarmML Project");
		newProjectPage.setDescription("Create a New Papyrus FarmML Project");
	...
	protected String[] getDiagramCategoryIds() {
		return new String[] { CreateFarmMLModelCommand.COMMAND_ID };
	}
